...
public class Anggotariwayatcontroller {
    ...
    @FXML
    private TableView<ObservableList<String>> tabelRiwayat;
    @FXML
    private TableColumn<ObservableList<String>, String> colIdTransaksi;
    @FXML
    private TableColumn<ObservableList<String>, String> colJudulBuku;
    @FXML
    private TableColumn<ObservableList<String>, String> colTglPinjam;
    @FXML
    private TableColumn<ObservableList<String>, String> colJatuhTempo;
    @FXML
    private TableColumn<ObservableList<String>, String> colTglKembali;
    @FXML
    private TableColumn<ObservableList<String>, String> colDenda;
    @FXML
    private TableColumn<ObservableList<String>, String> colStatusTrx;
    ...
    private void muatRiwayat(String filter) {
        ...
        String query = "SELECT t.idTransaksi, b.judul, t.tanggalPinjam, t.tanggalJatuhTempo, " +
